...
- interpretation of the obtained results (we won't just look at the fact, that you have applied the method to the the dataset itself, but also your motivation of using certain method)
- development of additional tools for the embeddings visualisation or/and development of additional techniques to e.g. find suitable hyper parameters.
